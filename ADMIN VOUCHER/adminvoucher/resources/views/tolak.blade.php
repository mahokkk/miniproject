        ...
        <div class="row">
          <div class="col-lg-6  w-100">
            <div class="card shadow mb-4">
              <div class="card-body">
                <h5 class="card-title">Voucher Tolak</h5>
              <div class="row">
                        ...
                        <table class="table table-borderless datatable">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $row->kategori }}</td>
                                <td><span class="badge text-bg-danger">{{ $row->status }}</span></td>
                                <td>{{ $row->alasan }}</td>
                                <td>
                                <a href="/tampil/{{ $row->id }}" class="btn btn-info"><i class="bi bi-pencil-square"></i> Edit</a> |
                                <a href="/hapus/{{ $row->id }}" class="btn btn-danger delete" data-id="{{ $row->id }}"><i class="bi bi-trash3-fill"></i> Delete</a>
                                </td>
                            </tr>
                            @endforeach
                          </tbody>
