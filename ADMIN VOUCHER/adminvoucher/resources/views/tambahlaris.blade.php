          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row mb-3">
                ...
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Jumlah Voucher</label>
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="jumlah_voucher" required>
                  </div>
                </div>
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-2 col-form-label">Total Voucher Yang Digunakan</label>
                    <div class="col-sm-10">
                      <input type="number" class="form-control" name="voucher_digunakan" id="voucher_digunakan" required>
                    </div>
                  </div>
                <div class="row mb-3">
                  <div class="col-sm-10">
                    <button  type="submit" class="btn btn-primary">Simpan Data</button>
                    <a href="/laris" type="submit" class="btn btn-danger">Kembali</a>
                  </div>
                </div>
