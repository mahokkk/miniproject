          ...
          <div class="col-lg-6  w-100">
            <div class="card shadow mb-4">
              ...
              <div class="card-header py-2">
                  <a type="button" href="/tambahvoucher" class="m-0 font-weight-bold btn btn-success"><i class="bi bi-database-add"></i> Tambah Data +</a>
              </div>
              <div class="row">
                        ...
                        <table class="table table-borderless datatable">
                          ...
                          <tbody>
                            ...
                            <tr>
                                <th scope="col">{{ ++$no}}</th>
                                <td>
                                    <img src="{{ asset('gambarvoucher/'.$row->gambar_voucher) }}" alt="" style="width: 100px; height: 100px;">
                                </td>
                                <td>{{ $row->voucher }}</td>
                                ...
                                <td>
                                <a href="/tampildata/{{ $row->id }}" class="btn btn-info"><i class="bi bi-pencil-square"></i> Edit</a> |
                                <a href="/delete/{{ $row->id }}" class="btn btn-danger delete" data-id="{{ $row->id }}"><i class="bi bi-trash3-fill"></i> Delete</a>
                                </td>
                            </tr>
                            @endforeach
                          </tbody>
